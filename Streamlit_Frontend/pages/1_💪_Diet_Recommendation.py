...
st.set_page_config(page_title="Automatic Recipe Recommendation", page_icon="💪",layout="wide")
...
class Display:
    ...
    def display_recommendation(self,person,recommendations):
        st.header('RECIPE RECOMMENDATOR')  
...
display=Display()
title="<h1 style='text-align: center;'>Automatic RECIPE Recommendation</h1>"
